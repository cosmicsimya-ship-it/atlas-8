 ...
 *
 * (Trimmed clean-port note: the observational evaluator/"Evaluate
 * interaction" admin action is intentionally excluded from this port —
 * this file only covers the read-only GET trace routes.)
 */
...
console.log('\n=== ATLAS LAB admin routes: real smoke test (message -> trace -> admin view) ===\n');
