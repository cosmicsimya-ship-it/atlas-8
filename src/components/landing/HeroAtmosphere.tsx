...
export default function HeroAtmosphere() {
  return (
    <div
      ...
      aria-hidden="true"
    >
      {/* Semi-transparent, not solid: same near-black as the page base, but
          lets ObservatoryField's grid/geometry (rendered behind this component
          in HeroSection) read through instead of being fully occluded. */}
      <div className="absolute inset-0 bg-[#030304] opacity-[0.72]" />
